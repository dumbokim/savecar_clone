...
export default function Apply() {
  return (
    <section id='apply_wrapper'>
        ...
        <div id='apply_input'>
          <div class='apply_input' id='apply_input1'>
            <label><span>*</span>이름</label>
            <br/>
            <input placeholder='이름을 입력해주세요' />
          </div>
          <div class='apply_input' id='apply_input2'>
            <label>연락처</label>
            <br/>
            <input placeholder='연락처를 입력해주세요' />
          </div>
          <br/>
          <div class='apply_input' id='apply_input3'>
            <label>차량명</label>
            <br/>
            <input placeholder='차량명을 입력해주세요' />
          </div>
          <div class='apply_input' id='apply_input4'>
            <label>지역</label>
            <br/>
            <input placeholder='지역을 입력해주세요' />
          </div>
          <br/>
          <div class='apply_input' id='apply_input_bottom'>
            <div id='apply_input5'>
              <label>대여 일자</label>
              <br/>
              <input placeholder='예상 대여일자를 입력해주세요' />
            </div>
            <div class='apply_input' id='apply_input6'>
              <label>요청 사항</label>
              <br/>
